...
namespace EkiHire.Data.Migrations
{
    ...
    [Migration("20210502144141_userimg_adpValue2")]
    partial class userimg_adpValue2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EkiHire.Core.Domain.Entities.Ad", b =>
                {
                    ...
                    b.Property<long?>("Bathroom")
                        .HasColumnType("bigint");

                    b.Property<long?>("Bedroom")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ExchangePossible")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EkiHire.Core.Domain.Entities.UserCart", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("EkiHire.Core.Domain.Entities.WorkExperience", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("EkiHire.Core.Domain.Entities.AdImage", b =>
                {
                    b.HasOne("EkiHire.Core.Domain.Entities.Ad", null)
                        .WithMany("AdImages")
                        .HasForeignKey("AdId");
                });
