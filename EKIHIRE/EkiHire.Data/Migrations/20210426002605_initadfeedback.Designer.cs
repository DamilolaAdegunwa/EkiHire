...
namespace EkiHire.Data.Migrations
{
    ...
    [Migration("20210426002605_initadfeedback")]
    partial class initadfeedback
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EkiHire.Core.Domain.Entities.City", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("EkiHire.Core.Domain.Entities.RealEstateStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("EkiHire.Core.Domain.Entities.State", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("EkiHire.Core.Domain.Entities.City", b =>
                {
                    b.HasOne("EkiHire.Core.Domain.Entities.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("EkiHire.Core.Domain.Entities.RealEstate", b =>
                {
                    b.HasOne("EkiHire.Core.Domain.Entities.City", "City")
                        .WithMany()
                        .HasForeignKey("CityId");

                    b.HasOne("EkiHire.Core.Domain.Entities.RealEstateStatus", "Status")
                        .WithMany()
